 ...
 * @description: 笛卡尔心形线
 * @author: linsz
 * @create: 2022-08-07 13:23
 **/
public class DescartesHeart extends JFrame{
    ...
    public static void main(String[] args) {
        DescartesHeart descartesHeart = new DescartesHeart();
        descartesHeart.setVisible(true);
    }
